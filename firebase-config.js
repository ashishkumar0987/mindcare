...
import { getFirestore } from "firebase/firestore";  // Firestore के लिए
import { getAuth, GoogleAuthProvider, onAuthStateChanged } from "firebase/auth";  // Auth के लिए
...
// Export the services (ये आपके frontend में use होंगे)
